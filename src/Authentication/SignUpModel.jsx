...
export default function SignUpModel({ closeModel }) {
  ...
  return (
    ...
    >
      <div className="fixed flex justify-center items-center z-50 w-full h-screen backdrop-blur-sm	">
        <div className="fixed  bg-white flex flex-col rounded-xl py-10 px-14 ">
          <div>
